...
{
    /// <summary>
    /// Classe de contexto para conexão do EntityFramework
...
public class DataContext : DbContext
    {
...

        {
            ...
            ("Data Source=localhost,1433;User ID=sa;Password=Coti2024!;Connect Timeout=30;Trust Server Certificate=True;");
        }
